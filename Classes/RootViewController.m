...
- (void)viewDidLoad {
	imageView.image=[UIImage imageNamed:[NSString stringWithFormat:@"%d.png",[[self.navigationController viewControllers]indexOfObject:self]]];
    [super viewDidLoad];
...
*/
-(void)push{
	RootViewController *anotherController=[[RootViewController alloc]init];
